...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(rest.DemoResource.class); // todo: delete later
        resources.add(rest.RenameMeResource.class); // todo: delete later
        resources.add(rest.ProtectedPagesResource.class);
        resources.add(rest.ExternResource.class);
